...
const url = "APP_URL"; // url хостинга

const bot = new Telegraf(BOT_TOKEN, options); // создаем новый экземпляр Telegram-бота

bot.setWebHook(`${url}/bot${token}`); /* После установки вебхука Telegram будет отправлять все входящие сообщения и события боту по этому URL-адресу.
